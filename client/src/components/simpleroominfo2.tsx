                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', margin: '0px 5px 0px 5px' }}>
                            ...
                            <Switch sx={{ margin: '0px 0px 0px 20px' }}
                                onChange={(e) => { }} />
                        </Box>
                        ...
                        <Box sx={{
                            display: 'flex', flexDirection: 'column', alignSelf: 'center',
                            margin: '0px 5px 0px 0px', padding: '0px 0px 0px 10px'
                        }}>
                            <Button variant="outlined" size='small' onClick={(e) => { navigate('/room') }}>
                                <Typography
                                    sx={{ fontSize: '20px', fontWeight: 'bold', alignSelf: 'center', margin: '0px 0px 0px 0ㅔㅌ' }}>
                                    방 나가기
                                </Typography>
                            </Button>
                        </Box>
...
export default SimpleRoomInfo2;